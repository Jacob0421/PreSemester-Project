...
namespace PreSemester_Project.Models
{
    ...
    public Volunteer Add(Volunteer volunteer)
        ...
        {
            Volunteer result = _volunteerList.FirstOrDefault(v => v.Username == userName);
            return result;
        }
